            ...
            <div class="row">
                <nav class="templatemo-top-nav col-lg-12 col-md-12">
                    <ul class="text-uppercase">
                        <li><a href="" class="active">车库信息</a></li>
                        <li><a href="addgarage.php">添加车库</a></li>
                        <li><a href="getgaragepdf.php">打印</a></li>
        ...
        <div class="templatemo-flex-row flex-content-row">
            <div class="col-1">
                <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                    ...
                    <div class="panel-heading templatemo-position-relative"><h2 class="text-uppercase">Garage Table</h2></div>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <?php do { ?>
                                <tr>
                                    ...
                                    <td><?php echo $row_Rsdb['latitude']; ?></td>
                                    <td><?php echo $row_Rsdb['longtitude']; ?></td>
                                    <td><?php echo $row_Rsdb['address']; ?></td>
                                    <td><?php echo $row_Rsdb['total_num']; ?></td>
                                    <td><?php echo $row_Rsdb['free_num']; ?></td>
                                    <td><?php echo $row_Rsdb['price_per_hour']; ?></td>
                                </tr>
